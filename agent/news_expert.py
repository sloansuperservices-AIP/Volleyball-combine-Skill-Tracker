...
def update_knowledge_base():
    ...
    kb['rules_and_regulations'] = {
        ...
        "highlights": [
            ...
            "SRVA Offer Policy: Offers are made through the SportsEngine portal and are considered binding once accepted."
        ]
    }
